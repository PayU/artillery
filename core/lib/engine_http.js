                    ...
                    .on('request', function(req) {
                        ...
                        req.on('response', function updateLatency(res) {
                            ...
                            if (res.request.timings) {
                                ...
                                timings.dns = res.request.timings.lookup - res.request.timings.socket || 0;
                                timings.tcp = res.request.timings.connect - res.request.timings.socket || 0;
                                timings.response = res.request.timings.response - res.request.timings.connect || 0;
